...
export const hardwareSignOutStartDate = new Date(2025, 0, 17, 6, 30);
export const hardwareSignOutEndDate = new Date(2025, 1, 18, 11, 0);
...
export const creditsAvailable = 300;
